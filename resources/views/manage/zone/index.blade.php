    ...
    <div class="row">
        <div class="col-xs-12">
            @include('manage.public.nav',['navs'=> [
               ['name' => '赛区管理', 'active'=> 'true'],
               ['name'=>'添加赛区','url'=>'/manage/zone/create']
           ]])
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="form-control" name="zonename"
                                       value="{{ \Illuminate\Support\Facades\Input::get('zonename') }}"/>
                            </div>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($lists as $item)
                            <tr>
                                ...
                                <td>{{ $item->zonename }}</td>
                                <td>
                                    <a href="{{ url('/manage/zone/'.$item->id.'/edit/') }}" class="btn btn-default">修改</a>
                                    <a href="{{ url('/manage/zone/'.$item->id) }}" class="btn btn-default delete">删除</a>
                                </td>
                            </tr>
                        @endforeach
                    </table>
