        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                    <form id="form1" enctype="multipart/form-data" method="post" action="{{url('/home/register/update/'.$info->id)}}">
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <div class="input-group input-group-lg col-xs-12 col-sm-12">
                            <label>姓名
                                <span style="color: #ff0000">*</span>
                            </label>
                            <input type="text" class="form-control" placeholder="姓名..例：张三" name="name" value="{{$info->name}}">
                        </div>
                        <div class="input-group">
                            ...
                            <div class="">
                                ...
                                <div class='radio-check'>
                                    <input type='radio' name='sex' id='radio2' value="2"  {{$info->sex == 2?'checked':''}}/>
                        ...
                        <div class="input-group input-group-lg col-xs-12 col-sm-12">
                            ...
                            <input type="text" class="form-control" placeholder="请输入日期，如：1995-06-08" name="age" value="{{ $info->age }}">
                        </div>
                        <div class="input-group input-group-lg col-xs-12 col-sm-12">
                            <label>有效证件
                                <span style="color: #ff0000">*</span>
                            </label>
                            <input type="text" class="form-control" placeholder="请输入身份证号，如：150632199506082387" name="valid_card" value="{{ $info->valid_card }}">
                        </div>
                        <div class="input-group input-group-lg col-xs-12 col-sm-12">
                            <label>联系电话
                                <span style="color: #ff0000">*</span>
                            </label>
                            <input type="text" class="form-control" placeholder="请输入电话，如：13811218798" name="phone" value="{{ $info->phone }}">
                        </div>
                        <div class="input-group input-group-lg col-xs-12 col-sm-12">
                            <label>邮箱
                                <span style="color: #ff0000">*</span>
                            </label>
                            <input type="text" class="form-control" placeholder="请输邮箱，如123456@qq.com" name="email" value="{{ $info->email }}">
                        </div>
                        <div class="input-group">
                            <label>报名方式
                                <span style="color: #ff0000">*</span>
                            ...
                            <div class="">
                                ...
                                <div class='radio-check'>
                                    <input type='radio' name='sign_mode' id='radio6' value="2" {{$info->sign_mode == 2?'checked':''}}/>
                        ...
                        <div class="btn-group col-xs-12 col-sm-12">
                            ...
                            <button class="btn btn-default btn-lg dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="txt"> {{$info->zone_id?$zoneInfo->zonename:'请选择'}} </span>
                            ...
                            <input type="text" name="zone_id" value="{{$info->zone_id}}" hidden>
                        ...
                        <div class="btn-group col-xs-12 col-sm-12">
                            ...
                            <button class="btn btn-default btn-lg dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="txt">{{$info->cate_id?$cateInfo->catename:'请选择'}}</span>
                                <span class="caret"></span>
                            </button>
                            <ul class="dropdown-menu">
                            ...
                            <input type="text" name="cate_id" value="{{$info->cate_id}}" hidden>
                        ...
                        <div class="input-group col-xs-12 col-sm-12" id="infoWrap">
                            ...
                            <a href="javascript:;" class="pull-right glyphicon glyphicon-plus" style="padding-top: 5px;" onclick="addInfo(this)"></a>
                                @if($info->team_msg)
                                @foreach($info->team_msg as $team)
                                    <div class="add_info_wrap">
                                        <div class="row">
                                            <div class="col-xs-4 col-sm-3">
                                                <input type="text" name="teamname[]"  placeholder="姓名：" value="{{$team['teamname']}}">
                                            </div>
                                            <div class="col-xs-4 col-sm-2">
                                                <input type="text" name="teamage[]" placeholder="年龄：" value="{{$team['teamage']}}">
                                            </div>
                                            <div class="col-xs-4 col-sm-2">
                                                <input type="text" name="teamsex[]" placeholder="性别：" value="{{$team['teamsex']}}">
                                            </div>
                                            <div class="col-xs-7 col-sm-3">
                                                <input type="text" name="teamphone[]" placeholder="联系电话：" value="{{$team['teamphone']}}">
                                            </div>
                                            <div class="col-xs-10 col-sm-4 last">
                                                <input type="text" name="teamvalid[]" placeholder="有效证件：" value="{{$team['teamvalid']}}">
                                            </div>
                                        </div>
                                        <div class="row">
                        ...
                        <div class="btn-group col-xs-12 col-sm-12">
                            ...
                            <button class="btn btn-default btn-lg dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="txt"> {{ $info->race_id ? $raceInfo->racename : '请选择' }} </span>
                                <span class="caret"></span>
                            </button>
                            <ul class="dropdown-menu">
                            ...
                            <input type="text" name="race_id" value="{{$info->race_id}}" hidden>
                        </div>
                        <div class="input-group">
                            <label>参赛作品视频上传
                                <span style="color: #ff0000">*</span>
                            ...
                            <div class="upload_video">
                                ...
                                {{--<video src="123.mp4" controls="controls" class="video-js"></video>--}}
                        ...
                        <div class="input-group">
                            ...
                            <div class="">
                                ...
                                <div class='radio-check'>
                                    <input type='radio' name='be_master' id='radio4' value="1" {{$info->be_master==1?'checked':''}}/>
